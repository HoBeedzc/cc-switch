...
try {
  ...
  console.log('  cc-switch use -p              # Switch to previous configuration');
  console.log('  cc-switch current             # Show current configuration');
  console.log('  cc-switch view <name>         # View configuration content');
  console.log('  cc-switch edit <name>         # Edit configuration content');
  console.log('');
  console.log('Configuration Operations:');
  console.log('  cc-switch cp <src> <dest>     # Copy configuration');
  console.log('  cc-switch mv <old> <new>      # Rename/move configuration');
  console.log('  cc-switch rm <name>           # Delete configuration');
  console.log('');
  console.log('Import/Export:');
  console.log('  cc-switch export <name> -o file.ccx    # Export configuration');
  console.log('  cc-switch export --all -o file.ccx     # Export all configurations');
  console.log('  cc-switch import file.ccx               # Import configurations');
  console.log('');
  console.log('Template Management:');
  console.log('  cc-switch edit -t <template>  # Edit/create template');
  console.log('  cc-switch edit -t --list      # List available templates');
  console.log('');
